...
with tf.device('/cpu:2'):
	hist = model.fit(x_train, q_train, epochs = 200, batch_size = 256, verbose = 1, validation_data=(x_test, q_test), use_multiprocessing=True, workers=1000)

model.save("MC_DROPOUT_OOD_SD_MODEL.h5")
